  ...
  return (
    <div className="admin-dashboard">
      <div className="dashboard-header">
        <h1 className="dashboard-title-animated">Admin Dashboard</h1>
        <p>
          Welcome back, Administrator! Manage your college operations,
          monitor student progress, and oversee faculty activities from this
          ...
          <div className="action-card" onClick={() => navigate("/faculty")}>
            <div className="card-icon faculty-icon">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M2 17L12 22L22 17" stroke="#10B981" strokeWidth="2" fill="none"/>
                <path d="M2 12L12 17L22 12" stroke="#10B981" strokeWidth="2" fill="none"/>
              </svg>
            </div>
          ...
          <div className="action-card" onClick={() => navigate("/announcements")}>
            <div className="card-icon announcements-icon">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M19 8.5L22 6V18L19 15.5" fill="#EF4444"/>
              </svg>
            </div>
          ...
          <div className="action-card" onClick={() => navigate("/reports")}>
            <div className="card-icon reports-icon">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M8 12L12 8L16 12L20 8" stroke="white" strokeWidth="2" fill="none"/>
